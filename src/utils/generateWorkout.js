import { allWorkouts, universalDefaults } from '../workouts/workoutData.js';
...
const getWorkoutCategory = () => {
  const categories = Object.keys(allWorkouts)
  const category = categories[getRandomInteger(0, categories.length - 1)]
  return allWorkouts.shooting
...
export const getWorkout = () => {
  ...
  // const isInARow = difficulty() === 'In A Row'
